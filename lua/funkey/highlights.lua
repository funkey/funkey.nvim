...
M.highlights = {
    ...
    debugBreakpoint = { fg = p.bg0, bg = p.replaceme },
    ...
    StorageClass = { fg = p.replaceme } + styles.keywords,
    Identifier = { fg = p.replaceme } + styles.identifiers,
    Constant = { fg = p.constant } + styles.variables,
    PreProc = { fg = p.keyword },
    PreCondit = { fg = p.replaceme },
    Include = { fg = p.keyword },
    Keyword = { fg = p.keyword } + styles.keywords,
    Define = { fg = p.replaceme },
    Typedef = { fg = p.replaceme },
    Exception = { fg = p.replaceme },
    Conditional = { fg = p.replaceme },
    Repeat = { fg = p.replaceme },
    Statement = { fg = p.replaceme },
    Macro = { fg = p.purple },
    Error = { fg = p.error },
    Label = { fg = p.hint },
