...
M.highlights = {
    ...
    ["@markup"] = { link = "@none" },
    ["@markup.heading"] = { fg = p.highlight, bold = true },
    ["@markup.link.label"] = { fg = p.highlight_secondary, underline = true },
    ["@markup.link.url"] = { fg = p.keyword, underline = true },
    ["@markup.list"] = { fg = p.keyword },
    ["@markup.list.checked"] = { fg = p.highlight_secondary },
    ["@markup.list.unchecked"] = { fg = p.highlight },
